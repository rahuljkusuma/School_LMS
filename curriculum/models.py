...
# from teaching_blog.app_users.views import user_login
import os
...
class Standard(models.Model):
    ...
    descriptor = models.TextField(max_length=500,blank=True)
...
class Lesson(models.Model):
    ...
    slug = models.SlugField(null=True, blank=True)
    video = models.FileField(upload_to=save_lesson_files, verbose_name="Videos", blank=True, null=True)
